...
import { SlidersHorizontal, Music, Sparkles, Save, Moon, Sun } from "lucide-react";
  ...
  return (
    <main className="login-page" style={{ position: "relative" }}>
      ...
      <section className="login-brand-panel" style={{ position: "relative", overflow: "hidden" }}>
        ...
        {/* Efeito de brilho de fundo (Mesh Gradient Glow) */}
        <div style={{
          position: "absolute",
          top: "-20%",
          left: "-20%",
          width: "60%",
          height: "60%",
          background: "radial-gradient(circle, rgba(123, 77, 245, 0.15) 0%, rgba(90, 34, 214, 0) 70%)",
          borderRadius: "50%",
          pointerEvents: "none"
        }} />
